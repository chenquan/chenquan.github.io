...
> ![img](http://img.my.csdn.net/uploads/201304/05/1365174192_8325.png)

​    其中x是n维特征向量，函数g就是logistic函数。

​    而![img](http://img.my.csdn.net/uploads/201304/05/1365174223_1807.png)的图像是

![](/img/pic1365174236_6175.png)
...
> > > 
> > >
> > > ![img](http://img.my.csdn.net/uploads/201304/05/1365174921_9452.png)

​    从而，当我们要判别一个新来的特征属于哪个类时，只需求![img](http://img.my.csdn.net/uploads/201304/05/1365175136_8232.png)即可，若![img](http://img.my.csdn.net/uploads/201304/05/1365175136_8232.png)大于0.5就是y=1的类，反之属于y=0类。

​    此外，![img](http://img.my.csdn.net/uploads/201304/05/1365175136_8232.png)只和![img](http://img.my.csdn.net/uploads/201304/05/1365175161_1760.png)有关，![img](http://img.my.csdn.net/uploads/201304/05/1365175169_2349.png)>0，那么![img](http://img.my.csdn.net/uploads/201304/05/1365175178_8905.png)，而g(z)只是用来映射，真实的类别决定权还是在于![img](http://img.my.csdn.net/uploads/201304/05/1365175189_9269.png)。再者，当![img](http://img.my.csdn.net/uploads/201304/05/1365175205_2324.png)时，![img](http://img.my.csdn.net/uploads/201304/05/1365175215_8446.png)=1，反之![img](http://img.my.csdn.net/uploads/201304/05/1365175233_9165.png)=0。如果我们只从![img](http://img.my.csdn.net/uploads/201304/05/1365175266_3733.png)出发，希望模型达到的目标就是让训练数据中y=1的特征![img](http://img.my.csdn.net/uploads/201304/05/1365175288_2654.png)，而是y=0的特征![img](http://img.my.csdn.net/uploads/201304/05/1365175299_9597.png)。Logistic回归就是要学习得到![img](http://img.my.csdn.net/uploads/201304/05/1365175329_6408.png)，使得正例的特征远大于0，负例的特征远小于0，而且要在全部训练实例上达到这个目标。

​    接下来，尝试把logistic回归做个变形。首先，将使用的结果标签y = 0和y = 1替换为y = -1,y = 1，然后将![img](http://img.my.csdn.net/uploads/201304/05/1365175711_9116.png)（![img](http://img.my.csdn.net/uploads/201304/05/1365175723_3132.png)）中的![img](http://img.blog.csdn.net/20140826150648949)替换为b，最后将后面的![img](http://img.my.csdn.net/uploads/201304/05/1365175737_9557.png)替换为![img](http://img.my.csdn.net/uploads/201304/05/1365175737_9557.png)（即![img](http://img.my.csdn.net/uploads/201304/05/1365175756_2693.png)）。如此，则有了![img](http://img.my.csdn.net/uploads/201304/05/1365175767_8636.png)。也就是说除了y由y=0变为y=-1外，线性分类函数跟logistic回归的形式化表示![img](http://img.my.csdn.net/uploads/201304/05/1365175792_4997.png)没区别。

​    进一步，可以将假设函数![img](http://img.my.csdn.net/uploads/201304/05/1365175830_5193.png)中的g(z)做一个简化，将其简单映射到y=-1和y=1上。映射关系如下：

> > > ![img](http://img.my.csdn.net/uploads/201304/05/1365175998_9759.png)
...
> > > ![img](http://img.blog.csdn.net/20140829134124453)

​    这个超平面可以用分类函数![img](http://img.blog.csdn.net/20131107201211968)表示，当f(x) 等于0的时候，x便是位于超平面上的点，而f(x)大于0的点对应 y=1 的数据点，f(x)小于0的点对应y=-1的点，如下图所示：

> > > ![img](http://img.blog.csdn.net/20140829134548371)

​    

注：有的资料上定义特征到结果的输出函数![img](http://img.blog.csdn.net/20131120103601656)，与这里定义的![img](http://img.blog.csdn.net/20131107201211968)

实质是一样的。为什么？因为无论是![img](http://img.blog.csdn.net/20131120103601656)，还是![img](http://img.blog.csdn.net/20131107201211968)，不影响最终优化结果。下文你将看到，当我们转化到优化![img](http://img.my.csdn.net/uploads/201210/25/1351141837_7366.jpg)的时候，为了求解方便，会把yf(x)令为1，即yf(x)是y(w^x + b)，还是y(w^x - b)，对我们要优化的式子max1/||w||已无影响。

​    （有一朋友飞狗来自Mare_Desiderii，看了上面的定义之后，问道：请教一下SVM functional margin 为![img](http://img.blog.csdn.net/20131111154113734)=y(wTx+b)=yf(x)中的Y是只取1和-1 吗？y的唯一作用就是确保functional margin的非负性？真是这样的么？当然不是，详情请见本文评论下第43楼）
...
​    定义函数间隔（用![img](http://img.blog.csdn.net/20140829135049264)表示）为：

 

​						![img](http://img.blog.csdn.net/20131107201248921)

​    而超平面(w，b)关于T中所有样本点(xi，yi)的函数间隔最小值（其中，x是特征，y是结果标签，i表示第i个样本），便为超平面(w, b)关于训练数据集T的函数间隔：

> >   	  ![img](http://img.blog.csdn.net/20131111154113734)= **min![img](http://img.blog.csdn.net/20131111154113734)**i  (i=1，...n)

​    但这样定义的函数间隔有问题，即如果成比例的改变w和b（如将它们改成2w和2b），则函数间隔的值f(x)却变成了原来的2倍（虽然此时超平面没有改变），所以只有函数间隔还远远不够。

​    事实上，我们可以对法向量w加些约束条件，从而引出真正定义点到超平面的距离--几何间隔（geometrical margin）的概念。

​    假定对于一个点 x ，令其垂直投影到超平面上的对应点为 x0 ，w 是垂直于超平面的一个向量，![img](http://img.blog.csdn.net/20140829135315499)为样本x到超平面的距离，如下图所示：
...
> > > > > 
> > > > >
> > > > > > ![img](http://img.blog.csdn.net/20131107201720515)
> > > > >
> > > > > 

​    其中||w||为w的二阶范数（范数是一个类似于模的表示长度的概念），![img](http://img.blog.csdn.net/20160118171730323)是单位向量（一个向量除以它的模称之为单位向量）。

​    又由于 x0 是超平面上的点，满足 f(x0)=0 ，代入超平面的方程![img](http://img.blog.csdn.net/20131107201104906)，可得![img](http://img.blog.csdn.net/20160117004048499)，即![img](http://img.blog.csdn.net/20160117004117802)。

​    随即让此式![img](http://img.blog.csdn.net/20131107201720515)的两边同时乘以![img](http://img.blog.csdn.net/20160117004629562)，再根据![img](http://img.blog.csdn.net/20160117004117802)和![img](http://img.blog.csdn.net/20160117004138049)，即可算出： 

​							![img](http://img.blog.csdn.net/20131107201759093)
γ

​    为了得到![img](http://img.blog.csdn.net/20140829135315499)的绝对值，令![img](http://img.blog.csdn.net/20140829135315499)乘上对应的类别 y，即可得出几何间隔（用![img](http://img.blog.csdn.net/20140829135609579)表示）的定义：

​							![img](http://img.blog.csdn.net/20131107201919484)
...
> > > ![img](http://img.blog.csdn.net/20140829135959290)

​    通过由前面的分析可知：函数间隔不适合用来最大化间隔值，因为在超平面固定以后，可以等比例地缩放w的长度和b的值，这样可以使得![img](http://img.blog.csdn.net/20131107201211968)的值任意大，亦即函数间隔![img](http://img.blog.csdn.net/20131111154113734)可以在超平面保持不变的情况下被取得任意大。但几何间隔因为除上了![img](http://img.blog.csdn.net/20131111154326078)，使得在缩放w和b的时候几何间隔![img](http://img.blog.csdn.net/20131111154137453)的值是不会改变的，它只随着超平面的变动而变动，因此，这是更加合适的一个间隔。换言之，这里要找的最大间隔分类超平面中的“间隔”指的是几何间隔。

   于是最大间隔分类器（maximum margin classifier）的目标函数可以定义为：

****![img](http://img.blog.csdn.net/20131111160612687)
...
​    回顾下几何间隔的定义![img](http://img.blog.csdn.net/20131107201919484)，可知：如果令函数间隔![img](http://img.blog.csdn.net/20131111154113734)等于1（之所以令![img](http://img.blog.csdn.net/20131111154113734)等于1，是为了方便推导和优化，且这样做对目标函数的优化没有影响，至于为什么，请见本文评论下第42楼回复），则有![img](http://img.blog.csdn.net/20131111154137453) = 1 / ||w||且![img](http://img.blog.csdn.net/20140829140642940)，从而上述目标函数转化成了

> > > ![img](http://img.my.csdn.net/uploads/201210/25/1351141837_7366.jpg)

​    相当于在相应的约束条件![img](http://img.blog.csdn.net/20140829140642940)下，最大化这个1/||w||值，而1/||w||便是几何间隔![img](http://img.blog.csdn.net/20131111154137453)。   

​    如下图所示，中间的实线便是寻找到的最优超平面（Optimal Hyper Plane），其到两条虚线边界的距离相等，这个距离便是几何间隔![img](http://img.blog.csdn.net/20131111154137453)，两条虚线间隔边界之间的距离等于2![img](http://img.blog.csdn.net/20131111154137453)，而虚线**间隔边界上的点则是支持向量**。由于这些支持向量刚好在虚线间隔边界上，所以它们满足![img](http://img.blog.csdn.net/20131111155244218)（还记得我们把 functional margin 定为 1 了吗？上节中：处于方便推导和优化的目的，我们可以令![img](http://img.blog.csdn.net/20131111154113734)=1），而对于所有不是支持向量的点，则显然有![img](http://img.blog.csdn.net/20131111155205109)。

> > 
> >
> > 

> > ![img](http://img.blog.csdn.net/20140829141714944)
...
​     由于求![img](file:///D:/Users/FLOYD/AppData/Local/Temp/TempPic/7MC_V(1%7B(25]VM%7BNDBE2[Y5.tmp)![img](http://img.my.csdn.net/uploads/201301/11/1357837136_7540.png)的最大值相当于求![img](file:///D:/Users/FLOYD/AppData/Local/Temp/TempPic/U8KNCTBNFLW~UQKHKF]P57C.tmp)![img](http://img.my.csdn.net/uploads/201301/11/1357837152_4634.png)的最小值，所以上述目标函数等价于（w由分母变成分子，从而也有原来的max问题变为min问题，很明显，两者问题等价）：
...
​     那什么是拉格朗日对偶性呢？简单来讲，通过给每一个约束条件加上一个拉格朗日乘子（Lagrange multiplier）![img](http://img.blog.csdn.net/20131111195836468)，定义拉格朗日函数（通过拉格朗日函数将约束条件融合到目标函数里去，从而只用一个函数表达式便能清楚的表达出我们的问题）：
...
​    容易验证，当某个约束条件不满足时，例如![img](http://img.blog.csdn.net/20131107202615937)，那么显然有![img](http://img.blog.csdn.net/20131107202642843)（只要令![img](http://img.blog.csdn.net/20131107202702265)即可）。而当所有约束条件都满足时，则最优值为![img](http://img.blog.csdn.net/20131111195433031)，亦即最初要最小化的量。

​    因此，在要求约束条件得到满足的情况下最小化![img](http://img.blog.csdn.net/20131111195324546)，实际上等价于直接最小化![img](http://img.blog.csdn.net/20131111195552578)（当然，这里也有约束条件，就是![img](http://img.blog.csdn.net/20131111195824031)≥0,i=1,…,n）   ，因为如果约束条件没有得到满足，![img](http://img.blog.csdn.net/20131111195552578)会等于无穷大，自然不会是我们所要求的最小值。
...
​    这里用![img](http://img.blog.csdn.net/20131107202721703)表示这个问题的最优值，且和最初的问题是等价的。如果直接求解，那么一上来便得面对w和b两个参数，而![img](http://img.blog.csdn.net/20131111195824031)又是不等式约束，这个求解过程不好做。不妨把最小和最大的位置交换一下，变成：

> 
>
> > ![img](http://img.my.csdn.net/uploads/201210/25/1351142316_5141.jpg)

​    交换以后的新问题是原始问题的对偶问题，这个新问题的最优值用![img](http://img.blog.csdn.net/20131107202736187)来表示。而且有![img](http://img.blog.csdn.net/20131107202736187)≤![img](http://img.blog.csdn.net/20131107202721703)，在满足某些条件的情况下，这两者相等，这个时候就可以通过求解对偶问题来间接地求解原始问题。

​    换言之，之所以从minmax的原始问题![img](http://img.blog.csdn.net/20131107202721703)，转化为maxmin的对偶问题![img](http://img.blog.csdn.net/20131107202736187)，一者因为![img](http://img.blog.csdn.net/20131107202736187)是![img](http://img.blog.csdn.net/20131107202721703)的近似解，二者，转化为对偶问题后，更容易求解。

​    下面可以先求L 对w、b的极小，再求L 对![img](http://img.blog.csdn.net/20131111195836468)的极大。

#### 2.1.2、KKT条件

​    上文中提到“![img](http://img.blog.csdn.net/20131107202736187)≤![img](http://img.blog.csdn.net/20131107202721703)在满足某些条件的情况下，两者等价”，~~这所谓的“满足某些条件”就是要满足KKT~~~~条件~~。
...
​    也就是说，原始问题通过满足KKT条件，已经转化成了对偶问题。而求解这个对偶学习问题，分为3个步骤：首先要让L(w，b，a) 关于 w 和 b 最小化，然后求对![img](http://img.blog.csdn.net/20131111195836468)的极大，最后利用SMO算法求解对偶问题中的拉格朗日乘子。

#### 2.1.3、对偶问题求解的3个步骤

​    **（1）**、首先固定*![img](http://img.blog.csdn.net/20131111195836468)，*要让 L 关于 w 和 b 最小化，我们分别对w，b求偏导数，即令 ∂L/∂w 和 ∂L/∂b 等于零（对w求导结果的解释请看本文评论下第45楼回复）：

​								![img](http://img.blog.csdn.net/20131107202220500)
...
​    从上面的最后一个式子，我们可以看出，此时的拉格朗日函数只包含了一个变量，那就是![img](http://img.blog.csdn.net/20131111195824031)（求出了![img](http://img.blog.csdn.net/20131111195824031)便能求出w，和b，由此可见，上文第1.2节提出来的核心问题：分类函数**![img](http://img.blog.csdn.net/20131107201211968)**也就可以轻而易举的求出来了）。

​    **（2）**、求对![img](http://img.blog.csdn.net/20131111195836468)的极大，即是关于对偶问题的最优化问题。经过上面第一个步骤的求w和b，得到的拉格朗日函数式子已经没有了变量w，b，只有![img](http://img.blog.csdn.net/20131111195836468)。从上面的式子得到：

> ![img](http://my.csdn.net/uploads/201206/02/1338605996_4659.jpg)

​    这样，

求出了![img](http://img.blog.csdn.net/20131111195824031)
...
​    **（3）**在求得L(w, b, a) 关于 w 和 b 最小化，以及对![img](http://img.blog.csdn.net/20131111195836468)的极大之后，最后一步则可以利用SMO算法求解对偶问题中的拉格朗日乘子![img](http://img.blog.csdn.net/20131111195836468)。

> ![img](http://my.csdn.net/uploads/201206/02/1338605996_4659.jpg)

​       上述式子要解决的是在参数![img](http://img.my.csdn.net/uploads/201304/05/1365176671_1627.png)![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/E0TMRYVUZDXF%F%7D%7BOKK6FS2.tmp)上求最大值W的问题，至于![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/]GR(Y%7B27@S9FMX5%60HI))UUT.tmp)![img](http://img.my.csdn.net/uploads/201304/05/1365176682_4857.png)和![img](http://img.my.csdn.net/uploads/201304/05/1365176690_4143.png)![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/%7D4YBUPTWG@]D6CCL3I0~7EH.tmp)都是已知数。要了解这个SMO算法是如何推导的，请跳到下文第3.5节、SMO算法。

​    到目前为止，我们的 SVM 还比较弱，只能处理线性的情况，下面我们将引入核函数，进而推广到非线性分类问题。

#### 2.1.5、线性不可分的情况

​    OK，为过渡到下节2.2节所介绍的核函数，让我们再来看看上述推导过程中得到的一些有趣的形式。首先就是关于我们的 hyper plane ，对于一个数据点 x 进行分类，实际上是通过把 x 带入到![img](http://img.blog.csdn.net/20131107201211968)算出结果然后根据其正负号来进行类别划分的。而前面的推导中我们得到 

> > > > 
> > > >
> > > > ![img](http://img.blog.csdn.net/20131111163543781)

​    因此**分类函数**为：

> > ![img](http://img.my.csdn.net/uploads/201210/25/1351142572_5782.jpg)

​    这里的形式的有趣之处在于，对于新点 *x*的预测，只需要计算它与训练数据点的内积即可（![img](http://img.blog.csdn.net/20131111163753093)表示向量内积），这一点至关重要，是之后使用 Kernel 进行非线性推广的基本前提。此外，所谓 Supporting Vector 也在这里显示出来——事实上，所有非Supporting Vector 所对应的系数![img](http://img.blog.csdn.net/20131111164022593)都是等于零的，因此对于新点的内积计算实际上只要针对少量的“支持向量”而不是所有的训练数据即可。

​    为什么非支持向量对应的![img](http://img.blog.csdn.net/20131111164022593)等于零呢？直观上来理解的话，就是这些“后方”的点——正如我们之前分析过的一样，对超平面是没有影响的，由于分类完全有超平面决定，所以这些无关的点并不会参与分类问题的计算，因而也就不会产生任何影响了。

​    回忆一下我们2.1.1节中通过 Lagrange multiplier得到的目标函数：

> ![img](http://img.my.csdn.net/uploads/201210/25/1351142613_4680.jpg)

​     注意到如果 xi 是支持向量的话，上式中红颜色的部分是等于 0 的（因为支持向量的 functional margin 等于 1 ），而对于非支持向量来说，functional margin 会大于 1 ，因此红颜色部分是大于零的，而![img](http://img.blog.csdn.net/20131111163835968)又是非负的，为了满足最大化，![img](http://img.blog.csdn.net/20131111163835968)必须等于 0 。这也就是这些非Supporting Vector 的点的局限性。 
...
> > ![img](http://img.blog.csdn.net/20140830002108254)
...
> > > > ![img](http://img.blog.csdn.net/20130820145544562)
...
​    而其中的![img](http://img.blog.csdn.net/20131111164022593)可以通过求解如下 dual 问题而得到的：

> 
>
> > ![img](http://img.my.csdn.net/uploads/201210/25/1351142906_9411.jpg)

​    这样一来问题就解决了吗？似乎是的：拿到非线性数据，就找一个映射 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/03D5.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/0028.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/22C5.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/0029.png) ，然后一股脑把原来的数据映射到新空间中，再做线性 SVM 即可。不过事实上没有这么简单！其实刚才的方法稍想一下就会发现有问题：在最初的例子里，我们对一个二维空间做映射，选择的新空间是原始空间的所有一阶和二阶的组合，得到了五个维度；如果原始空间是三维，那么我们会得到 19 维的新空间，这个数目是呈爆炸性增长的，这给 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/03D5.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/0028.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/22C5.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/0029.png) 的计算带来了非常大的困难，而且如果遇到无穷维的情况，就根本无从计算了。所以就需要 Kernel 出马了。
...
​    其中 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/03B1.png) 由如下 dual 问题计算而得：
...
- 多项式核![img](data:image/png;base64,)，显然刚才我们举的例子是这里多项式核的一个特例（R = 1，d = 2）。虽然比较麻烦，而且没有必要，不过这个核所对应的映射实际上是可以写出来的，该空间的维度是![img](http://img.my.csdn.net/uploads/201304/03/1364958204_2877.jpg)，其中 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/006D.png) 是原始空间的维度。
- 高斯核![img](http://img.my.csdn.net/uploads/201304/03/1364958259_8460.jpg)，这个核就是最开始提到过的会将原始空间映射为无穷维空间的那个家伙。不过，如果![img](http://img.my.csdn.net/uploads/201304/03/1364958296_7554.jpg)选得很大的话，高次特征上的权重实际上衰减得非常快，所以实际上（数值上近似一下）相当于一个低维的子空间；反过来，如果![img](http://img.my.csdn.net/uploads/201304/03/1364958296_7554.jpg)选得很小，则可以将任意的数据映射为线性可分——当然，这并不一定是好事，因为随之而来的可能是非常严重的过拟合问题。不过，总的来说，通过调控参数![img](http://img.my.csdn.net/uploads/201304/03/1364958296_7554.jpg)，高斯核实际上具有相当高的灵活性，也是使用最广泛的核函数之一。下图所示的例子便是把低维线性不可分的数据通过高斯核函数映射到了高维空间：
  ![img](http://img.blog.csdn.net/20130919095640250)
...
![img](http://img.blog.csdn.net/20131121105410546)
...
​    在本文第一节最开始讨论支持向量机的时候，我们就假定，数据是线性可分的，亦即我们可以找到一个可行的超平面将数据完全分开。后来为了处理非线性数据，在上文2.2节使用 Kernel 方法对原来的线性 SVM 进行了推广，使得非线性的的情况也能处理。虽然通过映射 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/03D5.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/0028.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/22C5.png)![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Main/Regular/141/0029.png) 将原始数据映射到高维空间之后，能够线性分隔的概率大大增加，但是对于某些情况还是很难处理。
...
> 
>
> ![img](http://img.blog.csdn.net/20131126154347453)
...
​    其中 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/0043.png) 是一个参数，用于控制目标函数中两项（“寻找 margin 最大的超平面”和“保证数据点偏差量最小”）之间的权重。注意，其中 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/03BE.png) 是需要优化的变量（之一），而 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/0043.png) 是一个事先确定好的常量。完整地写出来是这个样子：
...
​     将 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/0077.png) 带回 ![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Caligraphic/Regular/141/004C.png) 并化简，得到和原来一样的目标函数：
...
> ![img](http://img.blog.csdn.net/20130919094508562)
...
![img](http://blog.pluskid.org/MathJax/fonts/HTML-CSS/TeX/png/Math/Italic/141/0043.png)
...
> > ![img](http://img.blog.csdn.net/20131114203144875)
...
-  Novikoff定理：如果分类超平面存在, 仅需在序列![img](http://img.blog.csdn.net/20131114204020468)上迭代几次，在界为![img](http://img.blog.csdn.net/20131114204028093)的错误次数下就可以找到分类超平面，算法停止。

​    这里![img](http://img.blog.csdn.net/20131114204038984)，![img](http://img.blog.csdn.net/20131114204047671)为扩充间隔。根据误分次数公式可知, 迭代次数与对应于扩充(包括偏置)权重的训练集的间隔有关。
...
​    在给出几何间隔的定义之前，咱们首先来看下，如上图所示，对于一个点 x ，令其垂直投影到超平面上的对应的为 x0 ，由于 w 是垂直于超平面的一个向量，![img](http://img.blog.csdn.net/20131107212633859)为样本x到分类间隔的距离，我们有
...
​    Mercer定理 ：如果函数K是![img](http://img.blog.csdn.net/20131114211056687)上的映射（也就是从两个n维向量映射到实数域）。那么如果K是一个有效核函数（也称为Mercer核函数），那么当且仅当对于训练样例![img](http://img.blog.csdn.net/20131114211111875)，其相应的核函数矩阵是对称半正定的。 
...
> ![img](http://img.blog.csdn.net/20131119171556593)

​      ![img](http://img.blog.csdn.net/20131119171613656)
...
> > ![img](http://img.blog.csdn.net/20131111201149062)
...
> 
>
> > ![img](http://img.blog.csdn.net/20131111200941109)
>
> 
...
> > > ![img](http://img.blog.csdn.net/20131111201005062)

​    求解![img](http://img.blog.csdn.net/20131111201029218) 使![img](http://img.blog.csdn.net/20131111201045671)达到最小，正好是算术平均![img](http://img.blog.csdn.net/20131111201056140)。
...
> > > > 
> > > >
> > > > ![img](http://img.blog.csdn.net/20131119160327140)
> > > >
> > > > 
...
> > 
> >
> > ![img](http://img.blog.csdn.net/20131119160407609)
> >
> > 

​    则通过Q最小确定这条直线，即确定![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/]YZ7VSP6%60P(4J0K71WLL$5V.tmp)![img](http://img.blog.csdn.net/20131119160453328)，以![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/(T]H%%7BJ3R@I]GQ$%60EK]P5FM.tmp)![img](http://img.blog.csdn.net/20131119160502531)为变量，把它们看作是Q的函数，就变成了一个求极值的问题，可以通过求导数得到。

​    求Q对两个待估参数的偏导数：

> > > ![img](http://img.blog.csdn.net/20131119160514921)
...
> > ​        ![img](http://img.blog.csdn.net/20131119160555593)
...
> > ![img](http://img.blog.csdn.net/20131120105753218)
...
> > > > ![img](http://img.blog.csdn.net/20131120103601656)

​    注：这个u与我们之前定义的![img](http://img.blog.csdn.net/20131107201211968)实质是一样的。

​    接着，重新定义下咱们原始的优化问题，权当重新回顾，如下：

> > ![img](http://img.blog.csdn.net/20131120103959046)

​    求导得到：

> > ![img](http://img.blog.csdn.net/20131120104205453)

​    代入![img](http://img.blog.csdn.net/20131120103601656)中，可得![img](http://img.blog.csdn.net/20131120105420562)。

​    通过引入拉格朗日乘子转换为对偶问题后，得：

> > ![img](http://img.blog.csdn.net/20131120104258437)

  				s.t：![img](http://img.blog.csdn.net/20131120104335796)

​					且![img](http://img.blog.csdn.net/20131120104344000)

​    注：这里得到的min函数与我们之前的max函数实质也是一样，因为把符号变下，即由min转化为max的问题，且yi也与之前的![img](http://img.blog.csdn.net/20131120104727609)等价，yj亦如此。

​    经过加入松弛变量![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/%)0AC029OE_W9%7DELHM$3JVK.tmp)后，模型修改为：

> > ![img](http://img.blog.csdn.net/20131120105112312)
> >
> > 

> > > 
> > >
> > > ![img](http://img.blog.csdn.net/20131120105326156)

​    从而最终我们的问题变为：

> > ![img](http://img.blog.csdn.net/20131120105753218)

​    下面要解决的问题是：在![img](http://img.blog.csdn.net/20140917223126859)上求上述目标函数的最小值。为了求解这些乘子，每次从中任意抽取两个乘子![img](http://img.blog.csdn.net/20140917223344501)和![img](http://img.blog.csdn.net/20140917223154718)，然后固定![img](http://img.blog.csdn.net/20140917223344501)和![img](http://img.blog.csdn.net/20140917223154718)以外的其它乘子![img](http://img.blog.csdn.net/20140917223413501)，使得目标函数只是关于![img](http://img.blog.csdn.net/20140917223344501)和![img](http://img.blog.csdn.net/20140917223154718)的函数。这样，不断的从一堆乘子中任意抽取两个求解，不断的迭代求解子问题，最终达到求解原问题的目的。

​    而原对偶问题的子问题的目标函数可以表达为：

> > ![img](http://img.blog.csdn.net/20140909162540829)

​    其中

> > ![img](http://img.blog.csdn.net/20140909162911265)

​    为了解决这个子问题，首要问题便是每次如何选取![img](http://img.blog.csdn.net/20140917223344501)和![img](http://img.blog.csdn.net/20140917223154718)。实际上，其中一个乘子是违法KKT条件最严重的，另外一个乘子则由另一个约束条件选取。

​    根据KKT条件可以得出目标函数中![img](http://img.blog.csdn.net/20131111195824031)取值的意义：

> > > ![img](http://img.blog.csdn.net/20131120105843187)

> 

1. 对于第1种情况，表明![img](http://img.blog.csdn.net/20131111195824031)是正常分类，在间隔边界内部（我们知道正确分类的点![img](http://img.blog.csdn.net/20140917223345468)）；
2. 对于第2种情况，表明了![img](http://img.blog.csdn.net/20131111195824031)是支持向量，在间隔边界上；
3. 对于第3种情况，表明了![img](http://img.blog.csdn.net/20131111195824031)是在两条间隔边界之间；

- ![img](http://img.blog.csdn.net/20131120105945093)<=1但是![img](http://img.blog.csdn.net/20131111195824031)<C则是不满足的，而原本![img](http://img.blog.csdn.net/20131111195824031)=C
- ![img](http://img.blog.csdn.net/20131120105945093)>=1但是![img](http://img.blog.csdn.net/20131111195824031)>0则是不满足的，而原本![img](http://img.blog.csdn.net/20131111195824031)=0
- ![img](http://img.blog.csdn.net/20131120105945093)=1但是![img](http://img.blog.csdn.net/20131111195824031)=0或者![img](http://img.blog.csdn.net/20131111195824031)=C则表明不满足的，而原本应该是0<![img](http://img.blog.csdn.net/20131111195824031)<C

> > > ![img](http://img.blog.csdn.net/20140917211428859)

​    其中，

是常数。

​    两个因子不好同时求解，所以可先求第二个乘子![img](http://img.blog.csdn.net/20140917223154718)的解（![img](http://img.blog.csdn.net/20140917211615427)），得到![img](http://img.blog.csdn.net/20140917223154718)的解（![img](http://img.blog.csdn.net/20140917211615427)）之后，再用![img](http://img.blog.csdn.net/20140917223154718)的解（![img](http://img.blog.csdn.net/20140917211615427)）表示![img](http://img.blog.csdn.net/20140917211258703)的解（![img](http://img.blog.csdn.net/20140917211603025)）。

​    为了求解![img](http://img.blog.csdn.net/20140917211615427)，得先确定![img](http://img.blog.csdn.net/20140917211615427)的取值范围。假设它的上下边界分别为H和L，那么有：

> > > > > ![img](http://img.blog.csdn.net/20140917212018772)

​    接下来，综合![img](http://img.blog.csdn.net/20140917212046369)和![img](http://img.blog.csdn.net/20140917212056119)这两个约束条件，求取![img](http://img.blog.csdn.net/20140917211615427)的取值范围。

​    当y1 != y2时，根据![img](http://img.blog.csdn.net/20140917212056119)可得![img](http://img.blog.csdn.net/20140917223713557)，所以有![img](http://img.blog.csdn.net/20141210233122343)，![img](http://img.blog.csdn.net/20141210233135376)，如下图所示：

> > ![img](http://img.blog.csdn.net/20140917212349092)

​    当y1 = y2时，同样根据![img](http://img.blog.csdn.net/20140917212056119)可得：![img](http://img.blog.csdn.net/20140917223614125)，所以有![img](http://img.blog.csdn.net/20141210233152921)，![img](http://img.blog.csdn.net/20141210233202208)，如下图所示：

> > ![img](http://img.blog.csdn.net/20140917212546875)

​    如此，根据y1和y2异号或同号，可得出![img](http://img.blog.csdn.net/20140917211615427)的上下界分别为：

> > > ![img](http://img.blog.csdn.net/20140917212422859)

​    回顾下第二个约束条件![img](http://img.blog.csdn.net/20140917212056119)，令上式两边乘以y1，可得

> > > ![img](http://img.blog.csdn.net/20140909164502391)

​    其中，![img](http://img.blog.csdn.net/20140909164354343)。

​    因此![img](http://img.blog.csdn.net/20140917223344501)可以用![img](http://img.blog.csdn.net/20140917223154718)表示，![img](http://img.blog.csdn.net/20140917225145364?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdl9KVUxZX3Y=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)，从而把子问题的目标函数转换为只含![img](http://img.blog.csdn.net/20140917223154718)的问题：

> > > ![img](http://img.blog.csdn.net/20140909170457774)

​    对![img](http://img.blog.csdn.net/20140917223154718)求导，可得

> > ![img](http://img.blog.csdn.net/20140909170904988)

​    化简下：

> > 
> >
> > > ![img](http://img.blog.csdn.net/20140909170907640)
> >
> > 

​    然后将![img](http://img.blog.csdn.net/20140917225309870?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdl9KVUxZX3Y=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)、![img](http://img.blog.csdn.net/20140909164502391)、和![img](http://img.blog.csdn.net/20140909162911265)代入上式可得：

> > > ![img](http://img.blog.csdn.net/20140921114838239)

​    令![img](http://img.blog.csdn.net/20131120102813671)（表示预测值与真实值之差），![img](http://img.blog.csdn.net/20140917224103392)，然后上式两边同时除以![img](http://img.blog.csdn.net/20140917223956515)，得到一个关于单变量![img](http://img.blog.csdn.net/20140917223154718)的解：

> > > > ![img](http://img.blog.csdn.net/20140917213317884)

​    这个解没有考虑其约束条件![img](http://img.blog.csdn.net/20140917213244500)，即是未经剪辑时的解。

​    然后考虑约束![img](http://img.blog.csdn.net/20140917213244500)可得到经过剪辑后的![img](http://img.blog.csdn.net/20140917211615427)的解析解为：

> > > > > ![img](http://img.blog.csdn.net/20140917213408953)

​    求出了后![img](http://img.blog.csdn.net/20140917211615427)，便可以求出![img](http://img.blog.csdn.net/20140917211603025)，得![img](http://img.blog.csdn.net/20140917213703086)。

​    ![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/K39[UN21WF~__EGULXI4SBM.tmp)那么如何选择乘子![img](http://img.blog.csdn.net/20140917223344501)和![img](http://img.blog.csdn.net/20140917223154718)呢？

- 对于![img](http://img.blog.csdn.net/20140917223344501)，即第一个乘子，可以通过刚刚说的那3种不满足KKT的条件来找；
- 而对于第二个乘子![img](http://img.blog.csdn.net/20140917223154718)可以寻找满足条件 ：![img](http://img.blog.csdn.net/20140917223934406)的乘子。

​    而b在满足下述条件：

> > > ![img](http://img.blog.csdn.net/20140917213613796)

​    下更新b：

> > ![img](http://img.blog.csdn.net/20140917213709734)

> > ![img](http://img.blog.csdn.net/20140917213912504)

​    且每次更新完两个乘子的优化后，都需要再重新计算b，及对应的Ei值。

​    最后更新所有![img](http://img.blog.csdn.net/20140917223408203)，y和b，这样模型就出来了，从而即可求出咱们开头提出的分类函数：
...
1. 第一步选取一对![img](http://img.my.csdn.net/uploads/201304/05/1365177350_4416.png)![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/SSG](EM@FHBU%605_5%7B5F1_OL.tmp)和![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/]AL[X353KQY7M(IYOE6MT%60X.tmp)![img](http://img.my.csdn.net/uploads/201304/05/1365177362_5226.png)，选取方法使用启发式方法；
2. 第二步，固定除![img](http://img.my.csdn.net/uploads/201304/05/1365177350_4416.png)![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/N$L%7D%XJ$7AA%60%TB%V92K%7BHD.tmp)和![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/~C1IU@]J1DXV9$9YX62%7D7)Q.tmp)![img](http://img.my.csdn.net/uploads/201304/05/1365177362_5226.png)之外的其他参数，确定W极值条件下的![img](http://img.my.csdn.net/uploads/201304/05/1365177350_4416.png)![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/HT)S[GPKVJ3[1R63V%7DUZ]TN.tmp)，![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/C[Z9SLRU5YQO3TB4%7B0$J0GS.tmp)![img](http://img.my.csdn.net/uploads/201304/05/1365177362_5226.png)由![img](http://img.my.csdn.net/uploads/201304/05/1365177350_4416.png)![img](file:///C:/Users/ADMINI~1/AppData/Local/Temp/TempPic/S~[OYBZ0E@%7B]2%60~JOOH4HYA.tmp)表示。

​    假定在某一次迭代中，需要更新![img](http://img.blog.csdn.net/20131106172310703)，![img](http://img.blog.csdn.net/20131106172334265)对应的拉格朗日乘子![img](http://img.blog.csdn.net/20131106172347593)，![img](http://img.blog.csdn.net/20131106172359625)，那么这个小规模的二次规划问题写为：

> ![img](http://img.blog.csdn.net/20131106172007546)

这里

> ![img](http://img.blog.csdn.net/20131106171714031)![img](http://img.blog.csdn.net/20131106171728703)

​    知道了如何更新乘子，那么选取哪些乘子进行更新呢？具体选择方法有以下两个步骤：

1. 步骤1：先“扫描”所有乘子，把第一个违反KKT条件的作为更新对象，令为a1；
2. 步骤2：在所有不违反KKT条件的乘子中，选择使|E1 −E2|最大的a2进行更新，使得能最大限度增大目标函数的值（类似于梯度下降. 此外![img](http://img.blog.csdn.net/20131120102813671)，而![img](http://img.blog.csdn.net/20131120103601656)，求出来的E代表函数ui对输入xi的预测值与真实输出类标记yi之差）。
...
> ![img](http://img.blog.csdn.net/20131108093951609)
...
19. [数据挖掘掘中所需的概率论与数理统计知识、上](http://blog.csdn.net/v_july_v/article/details/8308762)；
...
- 15年1月8日，朋友陈笙再为本SVM一文弄了**最新的第二个LaTeX版本**，下载地址为：<http://pan.baidu.com/s/1eQrgiOU>。
