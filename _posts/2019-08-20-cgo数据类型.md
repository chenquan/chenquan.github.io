...
func main() {
	...
	arr0Hdr.Len = 10
	arr0Hdr.Cap = 10
	fmt.Println(arr0)         // [97 98 0 0 0 0 0 0 0 0]
	fmt.Println(string(arr0)) //ab

	// 通过切片语法转换
	arr1 := (*[31]byte)(unsafe.Pointer(&C.arr[0]))[:10:10]
	fmt.Println(arr1)         // [97 98 0 0 0 0 0 0 0 0]
	fmt.Println(string(arr1)) //ab
...
![img](/img/picture/20190820/x-ptr-to-y-ptr.uml.png)
...
![img](/img/picture/20190820/int32-to-char-ptr.uml.png)
...
![img](/img/picture/20190820/x-slice-to-y-slice.uml.png)
